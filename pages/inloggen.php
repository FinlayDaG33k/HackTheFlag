						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									...
									<div class="checkbox">
										<label>
											<input type="checkbox" name="remember"> Remember Me (TODO)
										</label>
									</div>
									<div class="g-recaptcha" data-sitekey="6LecLAsUAAAAAD4J6GtP5n9k_wKz_qKQvB4ZJFlW"></div>
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-10 col-lg-offset-2">
									...
									<a href="#">Wachtwoord Vergeten? (TODO)</a>
								</div>
							</div>
						</fieldset>
					</form>
